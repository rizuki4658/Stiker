                    ...
                    <div class="col-md-6" style="margin-left: auto; margin-right: auto;">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title mb-3">Quarter Reports</strong>
                            </div>
                            <div class="card-body">
                            ...
                            <?php } ?>
                                <form action="Dashboard Report.php" method="post">
                                    <input type="hidden" name="category" id="category" value="Quarter">
                                    <div class="form-group">
                                        <label for="Quarter" class="control-label mb-1"> Quarter </label>
